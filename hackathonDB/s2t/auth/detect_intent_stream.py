...
from gcloud_wrapper import run_cmd_once
...
if __name__ == "__main__":
    ...
    run_sample()
    print(cmd)
    #run cmd and take output
    cmd_out = run_cmd_once(cmd)
    print(cmd_out)
    text_to_wav("en-AU-Wavenet-A",cmd_out)
